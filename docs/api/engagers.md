...
| `role_level` | string \| null | Authority — the rank the title claims: `CXO` (Executive / Founder), `VP`, `DIR` (Director / Head of), `MGR`, `SENIOR_IC`, `IC`, `JUNIOR`, `UNK`. See [Authority](./posts#authority) |
