...
| `role_level` | string \| null | Authority — the rank the title claims: `CXO` (C-Level), `VP`, `DIR` (Director / Head of), `MGR`, `SENIOR_IC`, `IC`, `JUNIOR`, `UNK`. See [Authority](./posts#authority) |
