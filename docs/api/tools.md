...
Decode the UTC creation time embedded in a LinkedIn post URL, activity URL, or raw numeric snowflake ID.
...
```json
{
  "detail": "No valid LinkedIn ID found in: https://www.linkedin.com/in/johndoe"
}
```
