...
:::tip Best Practices
1. **Start specific** - Narrow searches are easier to refine than broad ones
2. **Test and iterate** - Monitor results for a few days and adjust
3. **Layer your filters** - Combine search keywords with AI filtering for precision
4. **Track competitors** - See what conversations they're part of
:::
...
**→** Learn the [search syntax](/search-syntax) to build effective queries

**→** Configure [AI filtering](/ai-filtering) to refine your results

**→** Explore the [API](/api/) to automate your workflow
